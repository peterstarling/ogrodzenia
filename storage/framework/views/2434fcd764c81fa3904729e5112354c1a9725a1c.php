  	...
  	<div class="carousel-inner">
		<div class="item">
		  	...
		  	<div class="carousel-caption">
				<h2>Wieloletnie doświadczenie <span class="sub-text-s">oraz zdobyta wiedza</span></h2>
				...
				<a href="<?php echo url('oferta/ogrodzenia.html'); ?>" class="button-more" target="_blank">Zobacz więcej</a>
		  	</div>
		</div>
		...
		<div class="item active">
		  	...
		  	<div class="carousel-caption">
				<h2>Stworzone dla&nbsp;ciebie <span class="sub-text-s">Wykonamy najtrudniejszy projekt</span></h2>
				...
				<a href="<?php echo url('http://www.balusteel.eu/'); ?>" class="button-more" target="_blank">Zobacz więcej</a>
		  	</div>
		</div>
		...
		<div class="item">
		  	...
		  	<div class="carousel-caption">
				<h2>Ułatwiamy codzienność <span class="sub-text-s">automatyka dla Ciebie</span></h2>
				...
				<p>Ułatwimy codzienność dzięki automatyce do bramy najlepszych producentów. Oferujemy sprzęt znanych marek takich jak FAAC czy Nice, jak również mniej znanych producentów (co nie znaczy, że gorszych) jak BFT czy Beninca. Proponujemy montaż, konserwację jak również serwis gwarancyjny i pogwarancyjny zamontowanych automatów. Dowiedz się więcej przechodząc do następnej podstrony gdzie opisaliśmy dla Ciebie możliwości zastosowania automatyki w Twoim domu.</p>
                                ...
                                <a href="<?php echo url('oferta/automatyka-do-bram.html'); ?>" class="button-more" target="_blank">Zobacz więcej</a>
		...
		<div class="item">
			...
			<div class="carousel-caption">
				<h2>Profesjonalny montaż <span class="sub-text-s">tylko najlepsi fachowcy</span></h2>
				...
				<p class="color-grey00">Brama garażowa to przeważnie największa ruchoma cześć w domu. Często obsługiwana jest za pomocą napędu elektrycznego. Zanim zdecydujemy się na wybór bramy, powinniśmy szczegółowo przeanalizować dostępne możliwości.</p>
                                ...
                                <a href="<?php echo url('oferta/bramy-garazowe.html'); ?>" class="button-more" target="_blank">Zobacz więcej</a>
			</div>
		</div>
		...
		<div class="item">
		  	...
		  	<div class="carousel-caption">
				<h2>Prywatność i bezpieczeństwo <span class="sub-text-s">zadbamy o to</span></h2>
				...
				<a href="<?php echo url('oferta/rolety-zewnetrzne.html'); ?>" class="button-more" target="_blank">Zobacz więcej</a>
	  		</div>
		</div>
		...
		<div class="item">
			...
			<div class="carousel-caption">
				<h2>Szybkość działania<span class="sub-text-s">Spóźniony klient? Pomożemy</span></h2>
				...
				<a href="<?php echo url('oferta/konstrukcje-stalowe.html'); ?>" class="button-more" target="_blank">Zobacz więcej</a>
			</div>
		</div>
	</div>
